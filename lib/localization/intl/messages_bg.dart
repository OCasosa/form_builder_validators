...
class FormBuilderLocalizationsImplBg extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get floatErrorText => 'Стойността трябва да бъде валидно число с плаваща запетая.';

  @override
  String get hexadecimalErrorText => 'Стойността трябва да бъде валиден шестнадесетичен номер.';
}
