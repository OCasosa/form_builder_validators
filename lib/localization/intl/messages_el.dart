...
class FormBuilderLocalizationsImplEl extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get floatErrorText => 'Η τιμή πρέπει να είναι έγκυρος δεκαδικός αριθμός κινητής υποδιαστολής.';

  @override
  String get hexadecimalErrorText => 'Η τιμή πρέπει να είναι έγκυρος δεκαεξαδικός αριθμός.';
}
